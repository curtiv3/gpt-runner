...
#
# Usage:
#   ./tools/protocol-zero.sh              # Scan entire codebase
#   ./tools/protocol-zero.sh --commit-msg "message"   # Validate commit message
#   ./tools/protocol-zero.sh --commit-msg-file path   # Validate commit message from file
...
# Directory names to exclude from scanning (Python-specific)
EXCLUDE_DIRS=(
    "__pycache__"
    ".git"
    ".venv"
